...
// The campaign hero transform: src/lib/tier/hero-band.ts (moved from here in #234).
import { withCampaignHero } from './lib/tier/hero-band';
import { refreshHeroIndex } from './lib/tier/hero-index';
