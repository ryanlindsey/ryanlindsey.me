 ...
 * shaped so it cannot be mistaken for a real 44-character base64 key. The
 * real value is the public key issue #310 step 1 generates; swapping it in
 * for the sentinel is the only change this file needs.
 *
 ...
 * this repository's choice and public/_headers is what ships it.
 *
